...
const LoanRequestLog: React.FC<UserProps> = ({ log = [], getUsers, isAdmin, user }) => {
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 z-0">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
              ...
              <th scope="col" className=" py-3">Account No.</th>
            ...
            {log.length === 0 ? (
              ...
              log.map((transaction, id) => (
                <tr key={transaction.id} className="border border-[#43424285]">
                  ...
                  <td className="text-[0.8rem] md:text-sm">{transaction.phone}</td>
